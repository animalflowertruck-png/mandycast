    ...
    <div className="relative flex items-center justify-center min-h-screen">
      ...
      <div className="relative z-10 w-full max-w-md bg-black/80 border border-yellow-500/40 shadow-[0_0_25px_rgba(255,215,0,0.5)] rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2 bg-gradient-to-r from-yellow-400 to-red-500 text-black font-bold rounded-lg shadow-[0_0_15px_rgba(255,215,0,0.6)] hover:scale-105 transform transition flex items-center justify-center gap-2"
          >
        ...
        <p className="text-sm text-center text-gray-400 mt-4">
          ...
          <a href="/auth/signup" className="text-yellow-400 hover:underline">
            Sign up
          </a>
        </p>
      </div>
